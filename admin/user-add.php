...
<tr><td class="label">用户名称</td><td class="input"><input type="text" class="txt u-ipt" name="username" /></td></tr>
<tr><td class="label">用户密码</td><td class="input"><input type="text" class="txt u-ipt" name="userpass" /></td></tr>
<tr><td class="label">确认密码</td><td class="input"><input type="text" class="txt u-ipt" name="confirmpass" /></td></tr>
<tr><td class="label">电子邮箱</td><td class="input"><input type="text" class="txt u-ipt" name="useremail" /></td></tr>
